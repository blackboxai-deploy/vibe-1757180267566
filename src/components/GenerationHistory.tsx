      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          <CardContent className="p-12 text-center">
            <div className="mb-6">
              <img 
                src="https://placehold.co/200x200?text=Empty+history+illustration+with+clock+and+document+icons" 
                ...
                <div className="flex-shrink-0">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://placehold.co/96x96?text=Failed+to+load+thumbnail';
                    }}
                  />
                </div>
